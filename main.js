...
const geometry = new THREE.TorusGeometry(5, .25, 15, 100)
...
const logoTexture = new THREE.TextureLoader().load("https://raw.githubusercontent.com/Command-Tech/CommandTech/master/assets/img/logo.png")
